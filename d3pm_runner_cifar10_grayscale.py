...
if __name__ == "__main__":
    ...
    for i in range(start_e, n_epoch):
        ...
        for x, cond in pbar:
            ...
            pbar.set_description(
                f"epoch: {i}, loss: {loss_ema:.4f}, norm: {norm:.4f}, param_norm: {param_norm:.4f}, vb_loss: {info['vb_loss']:.4f}, ce_loss: {info['ce_loss']:.4f}"
            )
            optim.step()
            global_step += 1
            ...
            if global_step % 600 == 1:
                ...
                with torch.no_grad():
                    ...
                    gif[0].save(
                        f"contents/cifar10/sample_{global_step}.gif",
                        save_all=True,
                        append_images=gif[1:],
                        duration=100,
                        loop=0,
                    ...
                    last_img = gif[-1]
                    last_img.save(f"contents/cifar10/sample_{global_step}_last.png")
